<template>
    <footer class="footer alqabas">
        <div class="container py-5">
            <div class="row">
                <div class="col-md-4">
                    <div class="d-flex flex-column align-items-end h-100">
                        <p class="mb-3 px-3 py-3">هدفنا</p>
                        <p class="mb-3 px-3 py-3 text-end">تصميم خدماتنا بناءً على متطلبات العملاء <br> لنقدم لهم خدمات
                            إدارة مرافق على أعلى <br> قدر من الكفاءة والفعالية والجودة</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex flex-column align-items-end h-100">
                ...
                <div class="col-md-4">
                    <div class="d-flex flex-column align-items-end h-100">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <img src="@/static/images/location.png" alt="" class="img-fluid img-width">
                        </div>
                        <div class="d-flex align-items-center justify-content-end">
                            <p class="mb-0 ms-2 px-3 py-3">+966 570573333</p>
                            <img src="@/static/images/telephone.png" alt="" class="img-fluid img-width">
                        </div>
                        <div class="d-flex align-items-center justify-content-end">
                            <p class="mb-0 ms-2 px-3 py-3">contact@essham.com.sa</p>
                            <img src="@/static/images/envelope.png" alt="" class="img-fluid img-width">
                        </div>
                    </div>
                </div>
            </div>
