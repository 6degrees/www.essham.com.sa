<template>
    <section class="p-5" id="AboutUs" dir="rtl">
      <div class="container mx-auto">
        <div class="d-flex flex-row" style="background-color: #E9EBEB;">
          <div class="col-1" style="background-color: #213141; width: 5px !important;" id="black-bar">&nbsp;</div>
          <div class="col me-5">
            <div class="row">
