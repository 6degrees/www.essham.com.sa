    ...
    <div class="carousel slide" data-bs-ride="carousel" id="carouselExampleRide">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="/images/Essham1.png" class="d-block w-100" alt="Slider image 1">
        </div>
        <div class="carousel-item">
          <img src="/images/Essham2.png" class="d-block w-100" alt="Slider image 2">
        </div>
        <div class="carousel-item">
          <img src="/images/Essham3.png" class="d-block w-100" alt="Slider image 3">
        </div>
      </div>
